...
import { Network, Users, GraduationCap, Plus, Building2, Target, Globe, Upload } from 'lucide-react';
...
type TabType = 'networks' | 'centers' | 'families' | 'departments' | 'objectives' | 'ods';
...
const MasterRecords = () => {
  ...
  useEffect(() => {
    ...
    setODS(mockODS);
  }, [setNetworks, setCenters, setFamilies, setDepartments, setObjectives, setODS]);
  ...
  const canShowImport = (tab: TabType) => {
    return ['centers', 'families', 'departments', 'objectives'].includes(tab);
  };
